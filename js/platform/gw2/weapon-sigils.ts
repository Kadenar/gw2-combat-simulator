...
export const DEFAULT_WEAPON_SIGILS: readonly (readonly string[])[] =
  Object.freeze([
...
export function setWeaponSigil(
  build: Gw2Build,
  setIndex: number,
  slotIndex: number,
  name: string,
...
export function aggregateSigilSet(
  sigilNames: readonly string[] | null | undefined,
): Gw2SigilSet {
