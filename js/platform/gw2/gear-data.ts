...
export const PREFIX_GROUPS = [
  {
    ...
    items: PREFIXES.filter(
      (prefix) =>
        !Object.values(GEAR_STATS_LOOKUP[prefix] || {}).some((stats) =>
...
function weaponData(
  wielding: string,
  weaponStrengthProfileId: string,
): Readonly<Gw2WeaponDataEntry> {
...
export const WEAPON_DATA: Readonly<
  Record<string, Readonly<Gw2WeaponDataEntry>>
> = {
...
function derivedProfessionWielding(
