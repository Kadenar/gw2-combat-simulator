...
import { CANONICAL_TARGET_CONDITIONS, canonicalTargetConditionName, targetHasCondition } from './target-state.js';
import type { Skill, SkillId } from '../engine/types.js';
import type { Gw2ModifierContext, Gw2TimedBuffApplication } from './types.js';
