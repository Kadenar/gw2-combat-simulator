...
/** Estimates total condition damage with the positive duration bonus capped at 100 percent. */
...
/** Combines general and condition-specific duration bonuses from an attribute table. */
...
/** Combines general and boon-specific duration bonuses from an attribute table. */
...
/** Builds an isolated tooltip damage preview from canonical hit and attribute data. */
