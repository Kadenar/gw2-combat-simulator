...
function composeModuleCatalog(modules: readonly NamedModule<object>[]): Readonly<CanonicalCatalog> {
...
function composeEventReactions(modules: readonly NamedModule<object>[]): Readonly<Record<string, unknown>> {
