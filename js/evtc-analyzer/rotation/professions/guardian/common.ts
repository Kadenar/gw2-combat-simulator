...
export function prepareGuardianActions(
  ...
  return recoverCompletedZeroDurationCasts(
    context,
    removeDuplicateZeroDurationInterrupts(actions),
  );
}
...
export function finalizeGuardianActions(
  ...
  return alignReplayCastLanes(
    context,
    removePostEncounterActions(context, actions),
  );
}
