...
export const REVENANT_ELITE_LEGEND_BY_SPECIALIZATION: Readonly<
...
export const REVENANT_RELEASE_POTENTIAL_BY_LEGEND: Readonly<
  Record<string, string>
> = Object.freeze({
...
export const REVENANT_RELEASE_POTENTIAL_SKILL_ID_BY_LEGEND: Readonly<
...
export function legalRevenantLegendIds(
  specialization = "Core",
): string[] {
...
export function isLegalRevenantLegendId(
  legendId: string,
  specialization = "Core",
): boolean {
