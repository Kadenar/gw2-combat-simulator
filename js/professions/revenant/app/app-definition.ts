...
export const revenantApp = defineProfessionApp({
  ...
  runtime: {
    ...
    buildConfigInputs: (app) => ({
      initialResource:
        (app.build as RevenantApplicationBuild).initialEnergy,
    }),
    buildConfigExtras: (app) => ({
      initialEnergy:
        (app.build as RevenantApplicationBuild).initialEnergy,
      selectedLegends: [
        ...(app.build as RevenantApplicationBuild).selectedLegends,
      ],
      startingLegend:
        (app.build as RevenantApplicationBuild).startingLegend,
      selectedDodge:
        (app.build as RevenantApplicationBuild).selectedDodge,
      allianceSide:
        (app.build as RevenantApplicationBuild).allianceSide,
    }),
  },
