...
const records: readonly Skill[] = [
  ...
  },
  {
    ...
    categories: ['Legendary Dragon', 'Consume'],
    nextChainId: null,
    flipSkillId: null
  },
  {
  ...
  },
  {
    ...
    description:
      'Summon a protective barrier around the tablet that blocks enemy projectiles.<br><br>If this skill is empowered, it also grants protection to allies around the tablet.',
    icon: 'https://wiki.guildwars2.com/wiki/Special:Redirect/file/Protective_Solace.png',
    type: 'Utility',
    slot: 'Utility',
    weapon: '',
    specialization: '',
    categories: ['Legendary Centaur'],
    nextChainId: null,
    flipSkillId: null
  },
  {
  ...
  },
  {
    ...
    description:
      'Strike enemies around you, inflicting weakness, gaining barrier, and gaining additional barrier per target hit.',
  ...
  },
  {
    ...
    description:
      "Strike enemies around you, inflicting bleeding and gaining Kalla's Fervor. Gain additional fervor stacks for each foe you hit.",
  ...
  },
  {
    ...
    description:
      'Strike enemies around you, inflicting vulnerability and gaining quickness. Gain additional quickness for each foe you hit.',
  ...
  },
  {
    ...
    description:
      'Launch a chain at your target. When the chain connects with a foe, it slows and taunts them. You take less damage from taunted foes.',
  ...
  },
  {
    ...
    description:
      'Release the tether, shadowstepping toward your tethered ally and granting barrier to allies in the surrounding area.',
  ...
  },
  {
    ...
    description:
      'Spawn a Fragment of Razah at your targeted location. Both you and the fragment attack with a scythe, damaging and inflicting conditions on foes at your location. Gain might for each enemy struck.<br>Resonance. This skill gains bonus effects depending on the legend equipped in the other slot.',
  ...
  },
  {
    ...
    description:
      'Whenever you use a Legendary Assassin skill or while channeling Impossible Odds, fire enchanted daggers at nearby enemies.',
...
export const REVENANT_SUPPLEMENTAL_SKILLS = Object.freeze(records.map((record) => Object.freeze(record)));
