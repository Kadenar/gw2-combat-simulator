...
export const RENEGADE_PROFILE_IDS = Object.freeze({
  ...
  ordersFromAboveRighteousRebel:
    "revenant.renegade.orders-from-above-righteous-rebel",
...
export const RENEGADE_ENHANCED_SKILL_BY_ID: Readonly<Record<number, SkillId>> =
  Object.freeze({
...
const RENEGADE_DECLARATIONS: readonly (Skill | BalanceProfile)[] =
  Object.freeze([
    renegadeBalanceProfile({
      ...
      profileKind: "trait",
      description:
        "Invoking Legendary Renegade grants resolution to nearby allies.",
    ...
    renegadeBalanceProfile({
      ...
      name: "Band Together",
      description:
        "After using a Legendary Renegade skill, the next one is instant and enhanced.",
      effects: [
        {
          type: "buff",
          kind: "band-together",
...
function isBalanceProfile(
  value: Skill | BalanceProfile,
): value is BalanceProfile {
  return "profileKind" in value;
}

export const RENEGADE_BALANCE_PROFILES: readonly BalanceProfile[] =
  Object.freeze(RENEGADE_DECLARATIONS.filter(isBalanceProfile));

export const RENEGADE_EXTRA_SKILLS: readonly Skill[] = Object.freeze(
  RENEGADE_DECLARATIONS.filter(
    (value): value is Skill => !isBalanceProfile(value),
  ),
);
