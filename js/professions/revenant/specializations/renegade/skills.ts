...
export const RENEGADE_PROFILE_SKILL_IDS = Object.freeze({
...
export const RENEGADE_SPIRIT_BOON_SKILL_ID =
  RENEGADE_PROFILE_SKILL_IDS.spiritBoon;
...
function hiddenRenegadeSkill(skill: Skill): Skill {
  return {
    type: "Action",
    slot: "Action",
    slotSelectable: false,
...
export const RENEGADE_EXTRA_SKILLS: readonly Skill[] = Object.freeze([
  hiddenRenegadeSkill({
    id: RENEGADE_PROFILE_SKILL_IDS.spiritBoon,
  ...
  hiddenRenegadeSkill({
    id: RENEGADE_PROFILE_SKILL_IDS.bandTogether,
    name: "Band Together",
    description:
  ...
  hiddenRenegadeSkill({
    id: RENEGADE_PROFILE_SKILL_IDS.kallasFervor,
    name: "Kalla's Fervor",
    maximumStacks: 5,
  ...
  hiddenRenegadeSkill({
    id: RENEGADE_PROFILE_SKILL_IDS.kallasFervorLastingLegacy,
  ...
  hiddenRenegadeSkill({
    id: RENEGADE_PROFILE_SKILL_IDS.heroicCommandLastingLegacy,
  ...
  hiddenRenegadeSkill({
    id: RENEGADE_PROFILE_SKILL_IDS.ordersFromAboveRighteousRebel,
  ...
  hiddenRenegadeSkill({
    id: RENEGADE_PROFILE_SKILL_IDS.razorclawsRageProc,
  ...
  hiddenRenegadeSkill({
    id: RENEGADE_PROFILE_SKILL_IDS.soulcleavesSummitProc,
  ...
  hiddenRenegadeSkill({
    id: RENEGADE_PROFILE_SKILL_IDS.endlessEnmity,
    name: "Endless Enmity",
  ...
  hiddenRenegadeSkill({
    id: RENEGADE_PROFILE_SKILL_IDS.bloodFury,
    name: "Blood Fury",
  ...
  hiddenRenegadeSkill({
    id: RENEGADE_PROFILE_SKILL_IDS.allForOne,
    name: "All for One",
  ...
  hiddenRenegadeSkill({
    id: RENEGADE_PROFILE_SKILL_IDS.vindication,
    name: "Vindication",
