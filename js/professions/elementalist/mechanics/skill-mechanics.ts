...
export const ELEMENTALIST_SKILL_MECHANICS: Readonly<Record<string, SkillFragment>> = Object.freeze(
  Object.fromEntries(entries)
);

export const ELEMENTALIST_IMPLEMENTED_SKILL_IDS = Object.freeze(Object.keys(ELEMENTALIST_SKILL_MECHANICS).map(Number));
