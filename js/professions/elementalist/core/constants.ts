...
export const AUTOATTACK_CHAIN_PRESERVING_SKILLS = new Set([
  "Ride the Lightning",
  "Relentless Fire",
  "Weave Self",
]);

export const HAMMER_ORB_SKILLS: Readonly<
...
export const HAMMER_DUAL_ORB_SKILLS: Readonly<
...
export const PISTOL_SKILL_ELEMENTS: Readonly<
  Record<string, ElementalistAttunement>
> = Object.freeze({
...
export const PISTOL_DUAL_ELEMENTS: Readonly<
  Record<string, readonly ElementalistAttunement[]>
> = Object.freeze({
...
export const PISTOL_NO_CONSUME = new Set([
  "Aerial Agility",
  "Aerial Agility (chain)",
  "Aerial Agility (dash)",
]);
export const PISTOL_NO_GRANT = new Set([
  "Aerial Agility (chain)",
  "Aerial Agility (dash)",
]);
...
export const AURA_TRANSMUTE_SKILLS: Readonly<Record<string, string>> =
  Object.freeze({
...
export const FULL_ETCHING_CHARGE_SKILLS = new Set([
  "Overload Fire",
  "Overload Air",
  "Overload Earth",
]);
