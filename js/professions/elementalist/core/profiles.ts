...
const namedBoon = (
  ...
  stacks: number,
  duration: number,
): SkillEffect => ({ type: "boon", name, boon, stacks, duration });
...
const namedCondition = (
  ...
  stacks: number,
  duration: number,
): SkillEffect => ({ type: "condition", name, condition, stacks, duration });

const aura = (
  name: string,
  auraName: string,
  duration: number,
): SkillEffect => ({ type: "buff", name, kind: auraName, stacks: 1, duration });

export const ELEMENTALIST_CORE_BALANCE_PROFILES: readonly BalanceProfile[] =
  Object.freeze([
    {
    ...
    variant(
      ELEMENTALIST_CORE_BALANCE_PROFILE_IDS.rockBarrier,
      ID.ROCK_BARRIER,
      "Rock Barrier - Stored Barrier",
    ...
    variant(
      ELEMENTALIST_CORE_BALANCE_PROFILE_IDS.arcaneEcho,
      ID.ARCANE_ECHO,
      "Arcane Echo - Cooldown Window",
      { durationMultiplier: 10, recharge: 1 },
    ),
    variant(
      ELEMENTALIST_CORE_BALANCE_PROFILE_IDS.grandFinale,
      ID.GRAND_FINALE,
      "Grand Finale - Active Orb Packets",
      {
        initialDelay: 0.68,
        effects: [
    ...
    variant(
      ...
      {
        effects: [
          aura("Fire", "Fire Aura", 3),
          namedCondition("Water", "Vulnerability", 4, 8),
        ],
      },
    ),
    variant(
    ...
    variant(
      ELEMENTALIST_CORE_BALANCE_PROFILE_IDS.moltenMeteor,
      ID.MOLTEN_METEOR,
      "Molten Meteor - Earth Bullet",
    ...
    variant(
      ...
      {
        effects: [
          aura("Water", "Frost Aura", 3),
          namedBoon("Air", "Superspeed", 1, 4),
        ],
      },
    ),
    variant(
    ...
    variant(
      ELEMENTALIST_CORE_BALANCE_PROFILE_IDS.ragingRicochet,
      ID.RAGING_RICOCHET,
      "Raging Ricochet - Fire Bullet",
      { effects: [namedBoon("Fire", "Might", 1, 10)] },
    ),
    variant(
      ELEMENTALIST_CORE_BALANCE_PROFILE_IDS.searingSalvo,
      ID.SEARING_SALVO,
      "Searing Salvo - Fire Bullet",
    ...
    variant(
      ...
      "Frozen Fusillade - Water Bullet",
      {
        initialDelay: 4,
        effects: [
          { type: "strike", coefficient: 0.75, hits: 1 },
          namedCondition("Water Bullet", "Bleeding", 5, 8),
        ],
      },
    ),
    variant(
      ELEMENTALIST_CORE_BALANCE_PROFILE_IDS.frigidFlurry,
      ID.FRIGID_FLURRY,
      "Frigid Flurry - Water Bullet",
      { procChance: 0.2 },
    ),
    variant(
      ELEMENTALIST_CORE_BALANCE_PROFILE_IDS.dazingDischarge,
      ID.DAZING_DISCHARGE,
      "Dazing Discharge - Air Bullet",
      { durationMultiplier: 5, rechargeMultiplier: 0.67 },
    ),
    variant(
    ...
    variant(
      ELEMENTALIST_CORE_BALANCE_PROFILE_IDS.fulgor,
      ID.FULGOR,
      "Fulgor - Pulses",
      {
        initialDelay: 0.32,
    ...
    variant(
      ELEMENTALIST_CORE_BALANCE_PROFILE_IDS.signetOfFire,
      ID.SIGNET_OF_FIRE,
    ...
    trait(
      ELEMENTALIST_CORE_BALANCE_PROFILE_IDS.empoweringFlame,
      "Empowering Flame",
      { attributeBonus: 150 },
    ),
    trait(
      ELEMENTALIST_CORE_BALANCE_PROFILE_IDS.burningPrecision,
      "Burning Precision",
      {
        procChance: 0.33,
        internalCooldown: 5,
    ...
    trait(
      ELEMENTALIST_CORE_BALANCE_PROFILE_IDS.smotheringAuras,
      "Smothering Auras",
      { durationMultiplier: 1.33 },
    ),
    trait(
      ELEMENTALIST_CORE_BALANCE_PROFILE_IDS.powerOverwhelming,
      "Power Overwhelming",
      { minimumStacks: 10, attributeBonus: 150, weaponAttributeBonus: 300 },
    ),
    trait(
      ELEMENTALIST_CORE_BALANCE_PROFILE_IDS.pyromancersTraining,
      "Pyromancer's Training",
      { rechargeMultiplier: 0.8 },
    ),
    trait(
      ELEMENTALIST_CORE_BALANCE_PROFILE_IDS.persistingFlames,
      "Persisting Flames",
      {
        maximumStacks: 5,
    ...
    trait(
      ELEMENTALIST_CORE_BALANCE_PROFILE_IDS.pyromancersPuissance,
    ...
    trait(
      ELEMENTALIST_CORE_BALANCE_PROFILE_IDS.zephyrsSpeed,
      "Zephyr's Speed",
      { criticalChance: 0.05 },
    ),
    ...
    trait(ELEMENTALIST_CORE_BALANCE_PROFILE_IDS.zephyrsBoon, "Zephyr's Boon", {
      effects: [
        namedBoon("Fury", "fury", 1, 5),
        namedBoon("Swiftness", "swiftness", 1, 5),
      ],
    }),
    ...
    trait(
      ELEMENTALIST_CORE_BALANCE_PROFILE_IDS.ferociousWinds,
      "Ferocious Winds",
      { attributeConversion: 0.07 },
    ),
    trait(
      ELEMENTALIST_CORE_BALANCE_PROFILE_IDS.electricDischarge,
      "Electric Discharge",
      {
        effects: [
          {
    ...
    trait(
      ELEMENTALIST_CORE_BALANCE_PROFILE_IDS.aeromancersTraining,
      "Aeromancer's Training",
      { attributeBonus: 150, rechargeMultiplier: 0.8 },
    ),
    ...
    trait(
      ELEMENTALIST_CORE_BALANCE_PROFILE_IDS.earthsEmbrace,
      "Earth's Embrace",
      {
        internalCooldown: 15,
    ...
    trait(
      ELEMENTALIST_CORE_BALANCE_PROFILE_IDS.serratedStones,
      "Serrated Stones",
      { durationMultiplier: 20 },
    ),
    trait(
      ELEMENTALIST_CORE_BALANCE_PROFILE_IDS.elementalShielding,
      "Elemental Shielding",
    ...
    trait(
      ELEMENTALIST_CORE_BALANCE_PROFILE_IDS.strengthOfStone,
      "Strength of Stone",
      {
    ...
    trait(
      ELEMENTALIST_CORE_BALANCE_PROFILE_IDS.geomancersTraining,
      "Geomancer's Training",
      { rechargeMultiplier: 0.8 },
    ),
    trait(
      ELEMENTALIST_CORE_BALANCE_PROFILE_IDS.writtenInStone,
      "Written in Stone",
      {
        effects: [
          aura("Restoration", "Frost Aura", 4),
          aura("Fire", "Fire Aura", 4),
          aura("Earth", "Magnetic Aura", 3),
        ],
      },
    ...
    trait(ELEMENTALIST_CORE_BALANCE_PROFILE_IDS.soothingIce, "Soothing Ice", {
      internalCooldown: 15,
      effects: [
        aura("Frost Aura", "Frost Aura", 4),
        namedBoon("Regeneration", "regeneration", 1, 4),
      ],
    }),
    trait(
      ELEMENTALIST_CORE_BALANCE_PROFILE_IDS.aquamancersTraining,
      "Aquamancer's Training",
      { rechargeMultiplier: 0.8 },
    ),
    trait(
      ELEMENTALIST_CORE_BALANCE_PROFILE_IDS.soothingPower,
      "Soothing Power",
      { attributeBonus: 300 },
    ),
    trait(
      ELEMENTALIST_CORE_BALANCE_PROFILE_IDS.arcaneProwess,
      "Arcane Prowess",
      {
    ...
    trait(
      ELEMENTALIST_CORE_BALANCE_PROFILE_IDS.arcanePrecision,
      "Arcane Precision",
      {
        procChance: 0.33,
        internalCooldown: 3,
    ...
    trait(
      ELEMENTALIST_CORE_BALANCE_PROFILE_IDS.renewingStamina,
      "Renewing Stamina",
      {
        internalCooldown: 10,
    ...
    trait(
      ELEMENTALIST_CORE_BALANCE_PROFILE_IDS.elementalAttunement,
    ...
    trait(
      ELEMENTALIST_CORE_BALANCE_PROFILE_IDS.elementalLockdown,
      "Elemental Lockdown",
      {
        internalCooldown: 1,
        effects: [
    ...
    trait(
      ...
      { attributeBonus: 180, rechargeMultiplier: 0.85 },
    ),
    trait(
      ELEMENTALIST_CORE_BALANCE_PROFILE_IDS.evasiveArcana,
      "Evasive Arcana",
      {
        internalCooldown: 10,
        effects: [
    ...
    trait(
      ELEMENTALIST_CORE_BALANCE_PROFILE_IDS.arcaneLightning,
      "Arcane Lightning",
      {
        attributeBonus: 150,
        effects: [
    ...
    trait(
      ELEMENTALIST_CORE_BALANCE_PROFILE_IDS.bountifulPower,
      "Bountiful Power",
      {
        threshold: 5,
        effects: [
...
export function elementalistBalanceProfile(
  context: unknown,
  id: SkillId,
...
export function elementalistBalanceValue(
  context: unknown,
  id: SkillId,
  field: string,
  fallback: number,
...
export function elementalistBalanceEffect(
  ...
  const effects = (
    elementalistBalanceProfile(context, id)?.effects || []
  ).filter(
...
export function elementalistEffectValue(
  ...
  const value = elementalistBalanceEffect(context, id, type, name, index)?.[
    field
  ];
  return Number.isFinite(Number(value)) ? Number(value) : fallback;
}
