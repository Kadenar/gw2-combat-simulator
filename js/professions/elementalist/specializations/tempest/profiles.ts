...
export const TEMPEST_BALANCE_PROFILES: readonly BalanceProfile[] =
  Object.freeze([
    {
    ...
    },
    {
      ...
      effects: [{ type: "strike", coefficient: 2.64, hits: 1 }],
    },
    ...
    trait(TEMPEST_BALANCE_PROFILE_IDS.harmoniousConduit, "Harmonious Conduit", {
      effects: [
        boon("Swiftness", "swiftness", 1, 8),
        boon("Stability", "stability", 1, 4),
      ],
    }),
    trait(
      TEMPEST_BALANCE_PROFILE_IDS.invigoratingTorrents,
      "Invigorating Torrents",
      {
        effects: [
          boon("Vigor", "vigor", 1, 5),
          boon("Regeneration", "regeneration", 1, 5),
        ],
      },
    ),
    trait(
      TEMPEST_BALANCE_PROFILE_IDS.transcendentTempest,
    ...
    trait(TEMPEST_BALANCE_PROFILE_IDS.lucidSingularity, "Lucid Singularity", {
      maximumStacks: 5,
      effects: [
        boon("Pulse Alacrity", "alacrity", 1, 1),
        boon("Final Alacrity", "alacrity", 1, 4.5),
      ],
    }),
