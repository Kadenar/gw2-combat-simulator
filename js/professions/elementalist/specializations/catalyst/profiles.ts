...
export const CATALYST_BALANCE_PROFILES: readonly BalanceProfile[] =
  Object.freeze([
    {
    ...
    trait(
      CATALYST_BALANCE_PROFILE_IDS.viciousEmpowerment,
      "Vicious Empowerment",
      {
    ...
    trait(
      CATALYST_BALANCE_PROFILE_IDS.energizedElements,
      "Energized Elements",
      {
        resourceGain: 2,
    ...
    trait(
      CATALYST_BALANCE_PROFILE_IDS.elementalEmpowerment,
    ...
    trait(
      CATALYST_BALANCE_PROFILE_IDS.spectacularSphere,
      "Spectacular Sphere",
      {
        effects: [
