...
export const ELECTRIC_ENCHANTMENT_ICON =
  "https://wiki.guildwars2.com/images/7/7b/Hare%27s_Agility.png";
export const CONJURED_WEAPONS = new Set([
  "Frost Bow",
  "Lightning Hammer",
  "Fiery Greatsword",
]);
export const ALTRUISTIC_ASPECT_BOONS: ReadonlyMap<
  SkillId,
...
export const FULL_SPEAR_ETCHINGS = new Set([
  "Volcano",
  "Jökulhlaup",
  "Derecho",
  "Haboob",
...
export const FAMILIAR_FLIP_DELAYS: Readonly<
...
export const FAMILIAR_INTERRUPT_WINDOWS: Readonly<
  Record<string, readonly [string, number]>
> = Object.freeze({
...
export const FAMILIAR_PROFILE_BY_BASIC: Readonly<Record<string, SkillId>> =
  Object.freeze({
