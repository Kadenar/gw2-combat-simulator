...
export function onEventScheduled(
  ...
  if (
    ...
    state.ignitePassiveReadyAt =
      event.at +
      elementalistBalanceValue(context, PROFILE.ignite, "pulseInterval", 1);
