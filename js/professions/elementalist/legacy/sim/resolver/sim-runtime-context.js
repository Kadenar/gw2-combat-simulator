import {
  ...
  applyResolvedHit,
} from "./sim-hit-resolution.js";
import {
  canTriggerShatteringIceProc,
  queueShatteringIceProc,
  shouldSkipHammerOrbHit,
} from "./sim-hit-trigger-rules.js";
...
import {
  ...
  applyOnAuraGainEffects as runAuraGainEffects,
} from "../mechanics/sim-aura-effects.js";
import { checkCombo } from "../mechanics/sim-combo-resolution.js";
import {
  getRelicStrikeMultiplier,
  checkRelicOnHit,
  trackBlightbringerPoison,
  checkBloodstoneBlast,
  triggerShackles,
} from "../mechanics/sim-relic-helpers.js";
import { pushTimedStack } from "../state/sim-runtime-state.js";
import { gainEndurance } from "../state/sim-endurance-state.js";
import {
  attunementAt,
  secondaryAttunementAt,
  mightStacksAt,
