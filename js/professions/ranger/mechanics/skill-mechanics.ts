...
export const RANGER_SKILL_MECHANICS: Readonly<Record<number, SkillFragment>> = Object.freeze({
...
export const RANGER_IMPLEMENTED_SKILL_IDS = Object.freeze(Object.keys(RANGER_SKILL_MECHANICS).map(Number));
