...
export const RANGER_CORE_BALANCE_PROFILES: readonly BalanceProfile[] =
  Object.freeze([
    {
    ...
    variant(
      RANGER_CORE_BALANCE_PROFILE_IDS.poisonousStrikes,
      ID.DOUBLE_ARC,
      "Poisonous Strikes",
      {
        playerStacks: 2,
    ...
    variant(
      ...
      "Sharpening Stone - Triggered Bleeding",
      {
        ...
        effects: [
          { type: "condition", condition: "Bleeding", stacks: 1, duration: 8 },
        ],
      },
    ),
    variant(
      RANGER_CORE_BALANCE_PROFILE_IDS.sunSpirit,
      ID.SUN_SPIRIT,
      "Sun Spirit - Solar Flare",
      {
        effects: [
          { type: "condition", condition: "Burning", stacks: 3, duration: 6 },
        ],
      },
    ),
    ...
    variant(
      RANGER_CORE_BALANCE_PROFILE_IDS.bloodThirst,
      ID.CRIPPLING_SHOT,
      "Blood Thirst",
      {
        playerStacks: 3,
        effects: [
          { type: "condition", condition: "Bleeding", stacks: 1, duration: 12 },
        ],
      },
    ),
    variant(
      RANGER_CORE_BALANCE_PROFILE_IDS.signetOfTheWild,
      ID.SIGNET_OF_THE_WILD,
      "Signet of the Wild - Passive",
      { attributeBonus: 180 },
    ),
    trait(
      RANGER_CORE_BALANCE_PROFILE_IDS.lightOnYourFeet,
      "Light on Your Feet",
      {
        durationPerTier: 2,
        minimumStacks: 1,
    ...
    trait(RANGER_CORE_BALANCE_PROFILE_IDS.rejuvenation, "Rejuvenation", {
      internalCooldown: 20,
      effects: [
        { type: "boon", boon: "regeneration", duration: 10, stacks: 1 },
      ],
    }),
    trait(RANGER_CORE_BALANCE_PROFILE_IDS.poisonMaster, "Poison Master", {
      effects: [
        { type: "condition", condition: "Poisoned", duration: 8, stacks: 2 },
      ],
    }),
    ...
    trait(
      RANGER_CORE_BALANCE_PROFILE_IDS.resoundingTimbre,
      "Resounding Timbre",
      {
    ...
    trait(RANGER_CORE_BALANCE_PROFILE_IDS.arachnophobia, "Arachnophobia", {
      ...
      effects: [
        { type: "condition", condition: "Torment", duration: 3, stacks: 1 },
      ],
    }),
    variant(
    ...
    trait(
      RANGER_CORE_BALANCE_PROFILE_IDS.trappersExpertise,
      "Trapper's Expertise",
      {
    ...
    trait(
      RANGER_CORE_BALANCE_PROFILE_IDS.stridersStrength,
      "Strider's Strength",
      {
        attributeBonus: 120,
      },
...
export function rangerBalanceProfile(
  context: unknown,
  id: SkillId,
...
export function rangerBalanceValue(
  context: unknown,
  id: SkillId,
  field: string,
  fallback: number,
