...
export const UNTAMED_BALANCE_PROFILES: readonly BalanceProfile[] =
  Object.freeze([
    {
    ...
    trait(UNTAMED_BALANCE_PROFILE_IDS.blindingOutburst, "Blinding Outburst", {
      effects: [
        { type: "condition", condition: "Blindness", duration: 2, stacks: 1 },
      ],
    }),
    trait(
      UNTAMED_BALANCE_PROFILE_IDS.ferociousSymbiosis,
      "Ferocious Symbiosis",
      {
        maximumStacks: 5,
