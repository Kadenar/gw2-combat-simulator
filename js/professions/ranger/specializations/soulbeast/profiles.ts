...
export const SOULBEAST_BALANCE_PROFILES: readonly BalanceProfile[] =
  Object.freeze([
    {
    ...
    },
    {
      ...
      profileKind: "skill-variant",
      effects: [
        { type: "condition", condition: "Weakness", duration: 10, stacks: 1 },
      ],
    },
    ...
    trait(SOULBEAST_BALANCE_PROFILE_IDS.wiltingStrike, "Wilting Strike", {
      effects: [
        { type: "condition", condition: "Weakness", duration: 4, stacks: 1 },
      ],
    }),
    ...
    trait(
      SOULBEAST_BALANCE_PROFILE_IDS.predatorsCunning,
      "Predator's Cunning",
      {
