 ...
 */
import { GUARDIAN_CORE_EXTRA_SKILLS, GUARDIAN_CORE_SKILL_MECHANICS } from '../core/skills.js';
...
export const GUARDIAN_SKILL_MECHANICS: Readonly<Record<string, SkillFragment>> = Object.freeze(
  Object.fromEntries(entries)
);

export const GUARDIAN_IMPLEMENTED_SKILL_IDS = Object.freeze(Object.keys(GUARDIAN_SKILL_MECHANICS).map(Number));

export const GUARDIAN_EXTRA_SKILLS: readonly Skill[] = GUARDIAN_CORE_EXTRA_SKILLS;
