...
export const DRAGONHUNTER_BALANCE_PROFILES: readonly BalanceProfile[] =
  Object.freeze([
    {
    ...
    trait(
      DRAGONHUNTER_BALANCE_PROFILE_IDS.soaringDevastation,
      "Soaring Devastation",
      {
        effects: [
    ...
    trait(
      DRAGONHUNTER_BALANCE_PROFILE_IDS.huntersDetermination,
      "Hunter's Determination",
      { resourceGain: 100 },
    ),
    trait(
      DRAGONHUNTER_BALANCE_PROFILE_IDS.huntersPremonition,
