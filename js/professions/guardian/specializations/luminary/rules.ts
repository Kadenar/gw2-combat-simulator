...
export const luminaryModifierRules: readonly Gw2ModifierRule[] = Object.freeze([
  {
    ...
    amount: 0.1,
    when: (context) =>
      guardianTimedBuffActive(context, "guardian-empowered-armaments"),
  },
  {
    ...
    amount: 0.07,
    when: (context) => {
      const armament = latestGuardianTimedBuff(
        context,
  ...
  },
  {
    ...
    amount: 0.1,
    when: (context) =>
      guardianTimedBuffActive(context, "guardian-piercing-stance"),
  },
  {
