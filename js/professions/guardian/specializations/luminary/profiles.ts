...
export const LUMINARY_BALANCE_PROFILES: readonly BalanceProfile[] =
  Object.freeze([
    {
    ...
    trait(
      LUMINARY_BALANCE_PROFILE_IDS.empoweredArmaments,
      "Empowered Armaments",
      {
        maximumStacks: 20,
        resourceGain: 6,
    ...
    trait(
      LUMINARY_BALANCE_PROFILE_IDS.illuminatingInspiration,
