...
export const FIREBRAND_BALANCE_PROFILES: readonly BalanceProfile[] =
  Object.freeze([
    {
    ...
    trait(
      FIREBRAND_BALANCE_PROFILE_IDS.archivistOfWhispers,
    ...
    trait(FIREBRAND_BALANCE_PROFILE_IDS.weightyTerms, "Weighty Terms", {
      resourceGain: 2,
      effects: [
        { type: "condition", condition: "Slow", stacks: 1, duration: 1.5 },
      ],
    }),
    ...
    trait(
      FIREBRAND_BALANCE_PROFILE_IDS.unrelentingCriticism,
