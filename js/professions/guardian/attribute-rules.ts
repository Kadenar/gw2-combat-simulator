 ...
 * @param {string} kind
 */
function timedBuffActive(context: Gw2ModifierContext, kind: string): boolean {
...
/** @param {Gw2ModifierContext} context */
function targetDisabled(context: Gw2ModifierContext): boolean {
  if (
...
export const guardianModifierRules: readonly Gw2ModifierRule[] = Object.freeze([
  {
  ...
  },
  {
    ...
    amount: 0.1,
    when: (context) => timedBuffActive(context, "guardian-empowered-armaments"),
  },
  {
    ...
    amount: 0.07,
    when: (context) => {
      const armament = latestTimedBuff(context, "guardian-radiant-armaments");
      return (
  ...
  },
  {
    ...
    operation: "damage-additive",
    amount: 0.1,
    when: (context) => timedBuffActive(context, "guardian-piercing-stance"),
  },
  {
  ...
  },
  {
    ...
    factor: 1.15,
    order: 100,
    when: (context) => timedBuffActive(context, "guardian-daring-advance"),
  },
  {
