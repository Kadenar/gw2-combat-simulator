...
function wikiSkillIcon(fileName: string): string {
  return `https://wiki.guildwars2.com/wiki/Special:Redirect/file/${encodeURIComponent(
    fileName,
  )}`;
}
...
export const GUARDIAN_BUNDLE_SKILLS: readonly GuardianSkill[] = Object.freeze([
  {
    ...
    description:
      "Final Charge. Grant resolution, stability, and swiftness to allies.",
  ...
  },
  {
    ...
    name: "Flame Surge",
    description:
      "Final Charge. Unleash a powerful wave of purging fire in front of and around you.",
  ...
  },
  {
    ...
    description:
      "Final Charge. Gain health and grant aegis, protection, and resolution to allies.",
  ...
  },
  {
    ...
    description:
      "Tome. Tales of desert blooms create a wave of healing for your allies.",
