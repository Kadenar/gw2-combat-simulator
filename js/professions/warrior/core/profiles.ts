...
export const WARRIOR_CORE_BALANCE_PROFILES: readonly BalanceProfile[] =
  Object.freeze([
    {
    ...
    trait(
      WARRIOR_CORE_BALANCE_PROFILE_IDS.berserkersPower,
      "Berserker's Power",
      {
        maximumStacks: 4,
        damageIncreasePerStack: 0.0375,
        effects: [
          { type: "buff", kind: "berserkers-power", stacks: 1, duration: 15 },
        ],
      },
    ),
    ...
    trait(
      WARRIOR_CORE_BALANCE_PROFILE_IDS.peakPerformance,
      "Peak Performance",
      {
        damageIncrease: 0.05,
        activeDamageIncrease: 0.1,
        effects: [
          { type: "buff", kind: "peak-performance", stacks: 1, duration: 6 },
        ],
      },
    ),
    ...
    trait(WARRIOR_CORE_BALANCE_PROFILE_IDS.furious, "Furious", {
      ...
      attributeBonus: 15,
      effects: [
        { type: "buff", kind: "furious-surge", stacks: 1, duration: 10 },
      ],
    }),
    ...
    trait(
      WARRIOR_CORE_BALANCE_PROFILE_IDS.mercilessHammer,
      "Merciless Hammer",
      {
        resourceGain: 7,
      },
    ...
    trait(
      WARRIOR_CORE_BALANCE_PROFILE_IDS.stalwartStrength,
      "Stalwart Strength",
      {
    ...
    trait(
      WARRIOR_CORE_BALANCE_PROFILE_IDS.aggressiveOnslaught,
    ...
    trait(
      WARRIOR_CORE_BALANCE_PROFILE_IDS.soldiersComfort,
      "Soldier's Comfort",
      {
    ...
    trait(
      WARRIOR_CORE_BALANCE_PROFILE_IDS.buildingMomentum,
      "Building Momentum",
      {
        resourceGain: 15,
      },
    ...
    trait(
      WARRIOR_CORE_BALANCE_PROFILE_IDS.pinnacleOfStrength,
    ...
    trait(
      WARRIOR_CORE_BALANCE_PROFILE_IDS.forcefulGreatsword,
      "Forceful Greatsword",
      {
        attributeBonus: 120,
    ...
    trait(
      WARRIOR_CORE_BALANCE_PROFILE_IDS.roaringReveille,
      "Roaring Reveille",
      {
        attributeBonus: 120,
      },
...
export function warriorBalanceProfile(
  context: unknown,
  id: SkillId,
