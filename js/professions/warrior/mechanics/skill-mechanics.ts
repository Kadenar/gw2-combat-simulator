...
export const WARRIOR_SKILL_MECHANICS: Readonly<Record<number, SkillFragment>> =
  Object.freeze({
...
export const WARRIOR_IMPLEMENTED_SKILL_IDS = Object.freeze(
  Object.keys(WARRIOR_SKILL_MECHANICS).map(Number),
);
