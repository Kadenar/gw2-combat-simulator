...
export const BLADESWORN_BALANCE_PROFILES: readonly BalanceProfile[] =
  Object.freeze([
    {
    ...
    trait(
      BLADESWORN_BALANCE_PROFILE_IDS.dragonscaleDefense,
      "Dragonscale Defense",
      {
    ...
    trait(BLADESWORN_BALANCE_PROFILE_IDS.fierceAsFire, "Fierce as Fire", {
      ...
      effects: [
        { type: "buff", kind: "fierce-as-fire", stacks: 1, duration: 15 },
      ],
    }),
