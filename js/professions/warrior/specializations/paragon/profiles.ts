...
export const PARAGON_BALANCE_PROFILES: readonly BalanceProfile[] =
  Object.freeze([
    {
    ...
    trait(
      PARAGON_BALANCE_PROFILE_IDS.strengtheningStanzas,
    ...
    trait(
      PARAGON_BALANCE_PROFILE_IDS.inspiringImplements,
