...
export const BERSERKER_BALANCE_PROFILES: readonly BalanceProfile[] =
  Object.freeze([
    {
    ...
    trait(
      BERSERKER_BALANCE_PROFILE_IDS.burstOfAggression,
      "Burst of Aggression",
      {
        effects: [
    ...
    trait(BERSERKER_BALANCE_PROFILE_IDS.lastBlaze, "Last Blaze", {
      ...
      effects: [
        { type: "condition", condition: "Burning", stacks: 1, duration: 4 },
      ],
    }),
