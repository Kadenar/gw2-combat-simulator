...
export const THIEF_CORE_BALANCE_PROFILES: readonly BalanceProfile[] =
  Object.freeze([
    {
    ...
    },
    {
      ...
      effects: [
        { type: "condition", condition: "Poisoned", stacks: 1, duration: 3 },
      ],
    },
    {
    ...
    trait(
      THIEF_CORE_BALANCE_PROFILE_IDS.thrillOfTheCrime,
      "Thrill of the Crime",
      {
        effects: [
    ...
    trait(
      THIEF_CORE_BALANCE_PROFILE_IDS.unrelentingStrikes,
      "Unrelenting Strikes",
      {
        internalCooldown: 8,
    ...
    trait(
      THIEF_CORE_BALANCE_PROFILE_IDS.shadowsRejuvenation,
    ...
    trait(
      THIEF_CORE_BALANCE_PROFILE_IDS.revealedTraining,
      "Revealed Training",
      {
        attributeBonus: 80,
...
export function thiefBalanceProfile(
  context: unknown,
  id: SkillId,
...
export function thiefBalanceProfileEffect(
