...
export const DAREDEVIL_BALANCE_PROFILES: readonly BalanceProfile[] =
  Object.freeze([
    {
    ...
    trait(
      DAREDEVIL_BALANCE_PROFILE_IDS.unhinderedCombatant,
    ...
    trait(
      DAREDEVIL_BALANCE_PROFILE_IDS.brawlersTenacity,
      "Brawler's Tenacity",
      {
        resourceGain: 15,
      },
