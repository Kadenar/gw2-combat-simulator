...
export const ANTIQUARY_BALANCE_PROFILES: readonly BalanceProfile[] =
  Object.freeze([
    {
    ...
    },
    {
      ...
      effects: [
        { type: "condition", condition: "Burning", stacks: 1, duration: 1 },
      ],
    },
    {
    ...
    trait(
      ANTIQUARY_BALANCE_PROFILE_IDS.prolificPlunderer,
      "Prolific Plunderer",
      { resourceGain: 1 },
    ),
    trait(
      ANTIQUARY_BALANCE_PROFILE_IDS.prodigiousPincher,
      "Prodigious Pincher",
      {
        threshold: 15,
      },
    ...
    trait(
      ANTIQUARY_BALANCE_PROFILE_IDS.enterprisingAristocrat,
      "Enterprising Aristocrat",
      { resourceGain: 2 },
    ),
    trait(
      ANTIQUARY_BALANCE_PROFILE_IDS.exhilaratingEphemera,
      "Exhilarating Ephemera",
      { durationMultiplier: 10, maximumStacks: 20 },
    ),
    trait(
      ANTIQUARY_BALANCE_PROFILE_IDS.possessiveHoarder,
      "Possessive Hoarder",
      {
        effects: [
    ...
    trait(
      ANTIQUARY_BALANCE_PROFILE_IDS.meticulousCustodian,
