...
export const DEADEYE_BALANCE_PROFILES: readonly BalanceProfile[] =
  Object.freeze([
    {
    ...
    },
    {
      ...
      effects: [
        { type: "condition", condition: "Torment", stacks: 1, duration: 1 },
      ],
    },
    {
      ...
      resourceGain: 4,
      effects: [
        { type: "condition", condition: "Torment", stacks: 1, duration: 0.5 },
      ],
    },
    {
    ...
    trait(
      DEADEYE_BALANCE_PROFILE_IDS.beQuickOrBeKilled,
