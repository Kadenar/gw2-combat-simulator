...
export const MESMER_CORE_CONTROL_SKILLS: ReadonlySet<number> =
  new Set<number>([
  ID.CHAOS_STORM,
  ID.ILLUSIONARY_WAVE,
  ID.MAGIC_BULLET,
...
export const MESMER_CORE_BLIND_SKILLS: ReadonlySet<number> =
  new Set<number>([
  ID.COUNTERSPELL,
...
export const MESMER_CORE_PEITHA_SKILLS: ReadonlySet<number> =
  new Set<number>([
  ID.BLINK,
  ID.PHASE_RETREAT,
  ID.AXES_OF_SYMMETRY
