...
export const TROUBADOUR_INSTRUMENT_PROFILE_IDS: Readonly<
  Record<number, string>
> = Object.freeze({
  [ID.LIVELY_LUTE]: TROUBADOUR_BALANCE_PROFILE_IDS.livelyLute,
  [ID.LIVELY_LUTE_ALTERNATE]:
    TROUBADOUR_BALANCE_PROFILE_IDS.livelyLuteAlternate,
  ...
  [ID.HARMONIOUS_HARP_ALTERNATE]:
    TROUBADOUR_BALANCE_PROFILE_IDS.harmoniousHarpAlternate,
...
export const TROUBADOUR_BALANCE_PROFILES: readonly BalanceProfile[] =
  Object.freeze([
    {
    ...
    tale(
      TROUBADOUR_BALANCE_PROFILE_IDS.honorableRogue,
    ...
    tale(
      TROUBADOUR_BALANCE_PROFILE_IDS.valiantMarshal,
    ...
    }),
    {
      ...
      effects: [
        ...
        },
        {
          ...
          name: "Delayed wave",
          coefficient:
            MESMER_TROUBADOUR_TRAIT_DAMAGE.SyncopateDelayedWave.coefficient,
