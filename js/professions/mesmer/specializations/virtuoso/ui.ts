...
export const virtuosoUi: Partial<ProfessionUiContract> & SchedulerRecord =
  Object.freeze({
    paletteGroups: (context: MesmerUiContext) =>
      mesmerMechanicPaletteGroups(context, VIRTUOSO_MECHANIC_SKILLS),
    skillBarGroups: () =>
      mesmerMechanicSkillBarGroups("Bladesongs", VIRTUOSO_MECHANIC_SKILLS),
