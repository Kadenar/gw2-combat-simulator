...
export const MESMER_MIRAGE_WEAPON_STRENGTH: Readonly<Record<string, number>> =
  Object.freeze({});
export const MESMER_MIRAGE_CLONE_ATTACKS: Readonly<
  Record<string, MesmerCloneAttack>
> = Object.freeze({});
export const MESMER_MIRAGE_AMBUSH_ATTACKS: Readonly<
...
export const MESMER_MIRAGE_PHANTASM_ATTACK_TIMINGS: Readonly<
  Record<number, Partial<MesmerPhantasmAttackTiming>>
> = Object.freeze({});
export const MESMER_MIRAGE_TRAIT_DAMAGE: Readonly<
  Record<string, MesmerTraitDamage>
> = Object.freeze({});
export const MESMER_MIRAGE_SHATTERS: Readonly<Record<number, MesmerShatter>> =
  Object.freeze({});
export const MESMER_MIRAGE_CONTROL_SKILLS: ReadonlySet<number> =
  new Set<number>([
  ID.MIRAGE_ADVANCE,
  ID.MIRAGE_THRUST
]);
export const MESMER_MIRAGE_BLIND_SKILLS: ReadonlySet<number> =
  new Set<number>([
  ID.MIRAGE_ADVANCE
]);
export const MESMER_MIRAGE_ARISTOCRACY_SKILLS: ReadonlySet<number> =
  new Set<number>([]);
export const MESMER_MIRAGE_PEITHA_SKILLS: ReadonlySet<number> =
  new Set<number>([
  ID.FALSE_OASIS,
  ID.CRYSTAL_SANDS,
  ID.MIRAGE_ADVANCE,
...
export const MESMER_MIRAGE_INSTRUMENTS: Readonly<
