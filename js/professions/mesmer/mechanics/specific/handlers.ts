...
function legacyWeaponStrength(
  ...
  return (
    ...
    WEAPON_STRENGTH[String(skill.weapon || "")]
  );
}
...
const replaceProfile = replaceSkillHandler<MesmerHandlerContext>(
  () => null,
);

export const mesmerSkillHandlers: Readonly<
