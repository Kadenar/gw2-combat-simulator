...
const MESMER_SHATTER_LOCKOUTS: readonly SkillLockout[] = Object.freeze([
  Object.freeze({ group: "mesmer.shatter", durationMs: 50 }),
]);

export const MESMER_SKILL_MECHANICS: Readonly<
...
const MESMER_NON_API_SKILLS: readonly MesmerSkill[] = Object.freeze([
  Object.freeze({
  ...
  Object.freeze({
    ...
    ...{
      ...
      ] satisfies readonly SkillEffect[],
    },
  }),
  Object.freeze({
    id: ID.POWER_SPIKE,
  ...
  Object.freeze({
    ...
    ...{
      name: "Swap Weapons",
      description:
        "Swap between weapon sets. The swap has a 10-second recharge.",
...
export const WEAPON_STRENGTH: Readonly<Record<string, number>> = {
  Axe: 1000,
  Dagger: 1000,
  Focus: 900,
  Greatsword: 1100,
 ...
 */
export const CLONE_ATTACKS: Readonly<Record<string, MesmerCloneAttack>> = {
  Axe: {
    weaponStrength: 28.5,
    sequence: [
      {
 ...
 */
export const AMBUSH_ATTACKS: Readonly<Record<string, MesmerAmbushAttack>> = {
  Axe: {
    id: 44321,
    name: "Imaginary Axes",
    icon: "https://render.guildwars2.com/file/38ED6AA595AEF00C0F704D0565DB7DD24B623850/1770513.png",
...
export const TRAIT_DAMAGE: Readonly<
...
export const SHATTERS: Readonly<Record<number, MesmerShatter>> = {
  [ID.MIND_WRACK]: {
    slot: 1,
    kind: "core-power",
...
export const CONTROL_SKILLS = new Set<number>([
  ID.CHAOS_STORM,
  ID.ILLUSIONARY_WAVE,
  ID.MAGIC_BULLET,
  ID.SIGNET_OF_DOMINATION,
...
export const BLIND_SKILLS = new Set<number>([
  ID.COUNTERSPELL,
  ID.SIGNET_OF_MIDNIGHT,
  ID.THE_PRESTIGE,
  ID.CHAOS_ARMOR,
...
export const ARISTOCRACY_SKILLS = new Set<number>([
  ID.MIND_SLASH,
  ID.MIND_GASH,
  ID.MIND_PIERCE,
  ID.RAIN_OF_SWORDS,
...
export const PEITHA_SKILLS = new Set<number>([
  ID.BLINK,
  ID.PHASE_RETREAT,
  ID.FALSE_OASIS,
  ID.CRYSTAL_SANDS,
...
export const INSTRUMENTS: Readonly<Record<number, MesmerInstrument>> = {
  [ID.LIVELY_LUTE]: {
    slot: 1,
    instrument: "Lute",
    coefficient: 3,
