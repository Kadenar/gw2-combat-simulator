...
import { MESMER_VIRTUOSO_SKILL_MECHANICS } from '../specializations/virtuoso/skills.js';
import {
...
export const BLIND_SKILLS = new Set([...MESMER_CORE_BLIND_SKILLS, ...MESMER_MIRAGE_BLIND_SKILLS]);
export const ARISTOCRACY_SKILLS = new Set([...MESMER_CORE_ARISTOCRACY_SKILLS, ...MESMER_VIRTUOSO_ARISTOCRACY_SKILLS]);
export const PEITHA_SKILLS = new Set([...MESMER_CORE_PEITHA_SKILLS, ...MESMER_MIRAGE_PEITHA_SKILLS]);
