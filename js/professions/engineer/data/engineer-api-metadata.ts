...
export const SKILLS: readonly EngineerSkill[] = [
  ...
  },
  {
    ...
    name: 'Rifle Turret',
    description:
      'Turret. Build a rifle turret that shoots at foes. Turrets automatically overcharge when they are first placed, and they can be overcharged manually as long as they stay active.',
  ...
  },
  {
    ...
    name: 'Elixir B',
    description:
      'Elixir. Drink Elixir B to gain fury, might, resolution, and swiftness, then extend the duration of boons on yourself.',
  ...
  },
  {
    ...
    name: 'Slick Shoes',
    description:
      'Gadget. Spray oil behind you, knocking down foes. If underwater, foes entering the field are blinded and slowed.',
  ...
  },
  {
    ...
    name: 'Elixir X',
    description:
      'Elixir. Drink Elixir X to become a rampaging brute, whirling tornado, or powerful lich. Underwater, become either a withering plague or a whirlpool.',
  ...
  },
  {
    ...
    name: 'Flame Turret',
    description:
      'Turret. Deploy a turret that burns foes. Turrets automatically overcharge when they are first placed, and they can be overcharged manually as long as they stay active.',
  ...
  },
  {
    ...
    name: 'Net Turret',
    description:
      'Turret. Build a net turret that immobilizes nearby foes. Turrets automatically overcharge when they are first placed, and they can be overcharged manually as long as they stay active.',
  ...
  },
  {
    ...
    name: 'Thumper Turret',
    description:
      'Turret. Build a high-health thumper turret that damages nearby foes. Turrets automatically overcharge when they are first placed, and they can be overcharged manually as long as they stay active.',
  ...
  },
  {
    ...
    name: 'Rocket Boots',
    description:
      'Gadget. Fly forward, removing movement-impairing conditions and damaging foes with your rocket exhaust. \nMovement-impairing conditions include cripple, chill, and immobilize.',
  ...
  },
  {
    ...
    name: 'Rocket Turret',
    description:
      'Turret. Build a turret that fires rockets. Turrets automatically overcharge when they are first placed, and they can be overcharged manually as long as they stay active.',
  ...
  },
  {
    ...
    name: 'A.E.D.',
    description:
      'Gadget. Activate your A.E.D., enabling the system to heal you after a brief period of time. If you take lethal damage while A.E.D. is active, it ends and heals you for a large amount, grants shock aura, and removes conditions.',
    icon: 'https://render.guildwars2.com/file/37E6184468482B012ACE173098B0784456CA31C5/699525.png',
    type: 'Heal',
    weapon: '',
    slot: 'Heal',
  ...
  },
  {
    ...
    description:
      'Exceed. Break stun effects and create a holographic shell that reduces incoming damage and grants stability. This skill grants more stability and lasts longer while above the heat threshold.',
  ...
  },
  {
    ...
    description:
      'Exceed. Create a holographic arena that grants you boons while inside of it. When activated above the heat threshold, the radius is increased and the user is granted barrier. Allies gain boons at reduced duration.',
  ...
  },
  {
    ...
    name: 'Gaseous State',
    description:
      'Stance. Sublimate, breaking stun from yourself. Remove movement-impairing conditions and prevent their reapplication.',
