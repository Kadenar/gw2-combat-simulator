...
export const HOLOSMITH_BALANCE_PROFILES: readonly BalanceProfile[] =
  Object.freeze([
    {
    ...
    trait(
      HOLOSMITH_BALANCE_PROFILE_IDS.solarFocusingLens,
      "Solar Focusing Lens",
      {
        minimumStacks: 2,
        maximumStacks: 6,
    ...
    trait(
      HOLOSMITH_BALANCE_PROFILE_IDS.photonicBlastingModule,
