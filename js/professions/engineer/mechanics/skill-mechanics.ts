...
} from "../specializations/amalgam/skills.js";
import {
  HOLOSMITH_SKILL_MECHANICS,
} from "../specializations/holosmith/skills.js";
import {
  MECHANIST_SKILL_MECHANICS,
} from "../specializations/mechanist/skills.js";
import {
  SCRAPPER_SKILL_MECHANICS,
} from "../specializations/scrapper/skills.js";
import type {
  SkillFragment,
} from "../../../platform/engine/types.js";

const fragments: readonly Readonly<Record<string, SkillFragment>>[] =
  Object.freeze([
    ENGINEER_CORE_SKILL_MECHANICS,
    SCRAPPER_SKILL_MECHANICS,
    HOLOSMITH_SKILL_MECHANICS,
...
function mergeMechanicsFragments():
  ...
  for (const fragment of fragments) {
    for (const [skillId, mechanics] of Object.entries(fragment)) {
      if (Object.hasOwn(result, skillId)) {
        throw new TypeError(
          `Duplicate Engineer skill mechanics id ${skillId}.`,
        );
      }
...
} from "../specializations/mechanist/mechanics.js";
