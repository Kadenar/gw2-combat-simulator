...
const EVIDENCE_BY_SPECIALIZATION = Object.freeze({
  ...
  "Death Magic": "remaining outgoing Necromancer trait families affect combat state",
  "Blood Magic": "cross-specialization Necromancer trait triggers remain executable",
  "Soul Reaping": "signet passives and Soul Battery are profession-owned resources",
  Reaper: "Reaper traits reduce shroud cooldowns and ignore minion critical hits",
  Scourge: "Scourge barrier, shroud, and greater-shade traits trigger precisely",
  Harbinger: "current Harbinger grandmaster traits use their live PvE mechanics",
  Ritualist: "Ritualist live spirit packets retain independent ownership and cadence",
});

const EVIDENCE_BY_TRAIT = Object.freeze({
  "Barbed Precision": "Barbed Precision uses centered deterministic expected procs",
  "Lingering Curse": "Lingering Curse increases scepter base duration beyond the stat cap",
  "Master of Corruption": "Blood Is Power and Plague Signet preserve transferred conditions",
  ...
  "Soul Barbs": "Soul Barbs and Dark Gunslinger change their documented outputs",
  "Dark Gunslinger": "Soul Barbs and Dark Gunslinger change their documented outputs",
  "Corrupted Talent": "Corrupted Talent owns the Harbinger shroud-entry life-force gain",
  "Death Perception": "the Power Harbinger trait set uses current critical and resource rules",
  "Wicked Corruption": "the Power Harbinger trait set uses current critical and resource rules",
  "Implacable Foe": "the Power Harbinger trait set uses current critical and resource rules",
  ...
  "Spawning Power": "Ritualist spirits attack, empower Essence Blast, and innervate",
  "Charged Souls": "Ritualist spirits attack, empower Essence Blast, and innervate",
  "Lingering Spirits": "Ritualist spirits attack, empower Essence Blast, and innervate",
});
