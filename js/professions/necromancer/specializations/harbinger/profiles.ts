...
export const HARBINGER_BALANCE_PROFILE_IDS = Object.freeze({
  ...
  elixirOfIgnoranceEmpowered:
    "necromancer.harbinger.elixir-of-ignorance-empowered",
  elixirOfAnguishEmpowered: "necromancer.harbinger.elixir-of-anguish-empowered",
  elixirOfAmbitionEmpowered:
    "necromancer.harbinger.elixir-of-ambition-empowered",
...
export const HARBINGER_BALANCE_PROFILES: readonly BalanceProfile[] =
  Object.freeze([
    {
    ...
    trait(
      HARBINGER_BALANCE_PROFILE_IDS.cascadingCorruption,
    ...
    variant(
      HARBINGER_BALANCE_PROFILE_IDS.elixirOfRiskEmpowered,
      "Elixir of Risk - Empowered",
      ID.ELIXIR_OF_RISK,
      {
        blightCost: 5,
        blightGain: 10,
    ...
    variant(
      HARBINGER_BALANCE_PROFILE_IDS.elixirOfBlissEmpowered,
      "Elixir of Bliss - Empowered",
      ID.ELIXIR_OF_BLISS,
      {
        blightCost: 5,
        blightGain: 10,
    ...
    variant(
      ...
      ID.ELIXIR_OF_AMBITION,
      {
        ...
        effects: [
          ...
          ...["Bleeding", "Burning", "Confusion", "Poisoned", "Torment"].map(
            (condition) => ({
              type: "condition",
              condition,
              stacks: 3,
    ...
    variant(
      HARBINGER_BALANCE_PROFILE_IDS.devouringCutEmpowered,
      "Devouring Cut - Empowered",
      ID.DEVOURING_CUT,
      {
        blightCost: 5,
        effects: [
    ...
    variant(
      HARBINGER_BALANCE_PROFILE_IDS.voraciousArcEmpowered,
      "Voracious Arc - Empowered",
      ID.VORACIOUS_ARC,
      {
        blightCost: 5,
        effects: [
...
export const HARBINGER_EMPOWERED_PROFILE_BY_SKILL_ID: Readonly<
