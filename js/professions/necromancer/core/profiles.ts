...
export const NECROMANCER_CORE_BALANCE_PROFILES: readonly BalanceProfile[] =
  Object.freeze([
    {
    ...
    trait(
      NECROMANCER_CORE_BALANCE_PROFILE_IDS.unyieldingBlast,
      "Unyielding Blast",
      {
        effects: [
          {
    ...
    trait(
      NECROMANCER_CORE_BALANCE_PROFILE_IDS.barbedPrecision,
      "Barbed Precision",
      {
        criticalChance: 0.33,
        effects: [
    ...
    trait(
      NECROMANCER_CORE_BALANCE_PROFILE_IDS.vampiricPresence,
      "Vampiric Presence",
      {
        cooldown: 1,
        effects: [
    ...
    trait(
      NECROMANCER_CORE_BALANCE_PROFILE_IDS.chillingDarkness,
      "Chilling Darkness",
      {
        cooldown: 3,
        effects: [
    ...
    trait(
      NECROMANCER_CORE_BALANCE_PROFILE_IDS.insidiousDisruption,
    ...
    trait(
      NECROMANCER_CORE_BALANCE_PROFILE_IDS.siphonedPower,
      "Siphoned Power",
      {
        cooldown: 1,
        effects: [
    ...
    trait(
      NECROMANCER_CORE_BALANCE_PROFILE_IDS.fleshOfTheMaster,
      "Flesh of the Master",
      { resourceGain: 2, maximumStacks: 30 },
    ),
    trait(
      NECROMANCER_CORE_BALANCE_PROFILE_IDS.deadlyStrength,
      "Deadly Strength",
      { attributePerStack: 10 },
    ),
    trait(
      NECROMANCER_CORE_BALANCE_PROFILE_IDS.awakenThePain,
      "Awaken the Pain",
      {
        attributePerStack: 10,
      },
    ...
    trait(
      NECROMANCER_CORE_BALANCE_PROFILE_IDS.spitefulFortitude,
      "Spiteful Fortitude",
      { attributeConversion: 0.1, lifeForceGain: 1 },
    ),
    trait(
      NECROMANCER_CORE_BALANCE_PROFILE_IDS.furiousDemise,
      "Furious Demise",
      {
        attributeBonus: 180,
      },
    ...
    trait(
      NECROMANCER_CORE_BALANCE_PROFILE_IDS.targetTheWeak,
      "Target the Weak",
      {
    ...
    trait(
      NECROMANCER_CORE_BALANCE_PROFILE_IDS.lingeringCurse,
      "Lingering Curse",
      {
        attributeBonus: 200,
    ...
    trait(
      NECROMANCER_CORE_BALANCE_PROFILE_IDS.vitalPersistence,
      "Vital Persistence",
      { attributeBonus: 180 },
    ),
    trait(
      NECROMANCER_CORE_BALANCE_PROFILE_IDS.spitefulSpirit,
      "Spiteful Spirit",
      {
        effects: [
          {
...
export const NECROMANCER_MINION_PROFILE_BY_SKILL_ID: Readonly<
...
export function necromancerBalanceProfile(
  context: unknown,
  id: SkillId,
