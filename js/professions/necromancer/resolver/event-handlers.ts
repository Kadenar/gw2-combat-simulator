...
const SCOURGE_SHROUD_SKILL_IDS: ReadonlySet<SkillId> = new Set([
...
function targetBelowHalfHealth(
  context: NecromancerResolverContext,
): boolean {
...
function weaponSpellRecipientKeys(
  event: NecromancerResolverEvent,
): string[] {
...
function reactToNecromancerDamage(
  context: NecromancerResolverContext,
  event: NecromancerResolverEvent,
  details: NecromancerResolverReactionDetails = {},
): void {
  ...
  const scourgeShadeStrike =
    Boolean(skill && SCOURGE_SHROUD_SKILL_IDS.has(skill.id)) &&
...
function reactToNecromancerCondition(
  context: NecromancerResolverContext,
  event: NecromancerResolverEvent,
  details: NecromancerResolverReactionDetails = {},
): void {
...
function reactToNecromancerBlind(
  context: NecromancerResolverContext,
  event: NecromancerResolverEvent,
  details: NecromancerResolverReactionDetails = {},
): void {
...
function reactToNecromancerControl(
  context: NecromancerResolverContext,
  event: NecromancerResolverEvent,
  details: NecromancerResolverReactionDetails = {},
): void {
