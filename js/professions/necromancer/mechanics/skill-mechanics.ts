...
> = Object.freeze(Object.fromEntries(
  Object.entries(NECROMANCER_BASE_SKILL_MECHANICS).flatMap(
    ([skillId, mechanics]) => mechanics.quicknessCastTimeMs == null
      ? []
      : [[skillId, Number(mechanics.quicknessCastTimeMs)]],
  ),
));
...
export const NECROMANCER_SKILL_MECHANICS = applyNecromancerSkillDefaults(
