...
const entries: ProfessionRegistryEntry[] = [
  // Light armor: Elementalist, Mesmer, Necromancer.
  {
    ...
    loadAppAdapter: async () => {
      const module = await import('../../professions/elementalist/app/app-definition.js');
  ...
  },
  {
    ...
    loadAppAdapter: async () => {
      const module = await import('../../professions/mesmer/app/app-definition.js');
  ...
  },
  {
    ...
    loadAppAdapter: async () => {
      const module = await import('../../professions/necromancer/app/app-definition.js');
  ...
  // Medium armor: Ranger, Thief, Engineer.
  {
    ...
    loadAppAdapter: async () => {
      const module = await import('../../professions/ranger/app/app-definition.js');
  ...
  },
  {
    ...
    loadAppAdapter: async () => {
      const module = await import('../../professions/thief/app/app-definition.js');
  ...
  },
  {
    ...
    loadAppAdapter: async () => {
      const module = await import('../../professions/engineer/app/app-definition.js');
  ...
  // Heavy armor: Guardian, Warrior, Revenant.
  {
    ...
    loadAppAdapter: async () => {
      const module = await import('../../professions/guardian/app/app-definition.js');
  ...
  },
  {
    ...
    loadAppAdapter: async () => {
      const module = await import('../../professions/warrior/app/app-definition.js');
  ...
  },
  {
    ...
    loadAppAdapter: async () => {
      const module = await import('../../professions/revenant/app/app-definition.js');
