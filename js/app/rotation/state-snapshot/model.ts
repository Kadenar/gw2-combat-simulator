/**
 * Builds the inspectable rotation state at the insertion cursor or rotation end.
 * Keeping these simulation queries separate lets profession UI modules reuse
 * the same buff and critical-chance calculations without depending on the DOM.
 */
