...
import { applyHgh, observeEngineerHghEvent } from '#gw2/content/professions/engineer/core/traits/alchemy.js';
import {
  engineerCoreCriticalHitDefinitions,
  applyHematicFocus,
  applySanguineArray,
  applyThermalVision
} from '#gw2/content/professions/engineer/core/traits/firearms.js';
import {
...
} from '#gw2/content/professions/engineer/core/traits/explosives.js';
import {
  applyEngineerToolbeltTraits,
  applyStreamlinedKits,
  isEngineerToolbeltSkill,
  recordStaticDischargeProc
} from '#gw2/content/professions/engineer/core/traits/tools.js';
