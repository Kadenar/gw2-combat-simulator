...
import type { GuardianCastContext, GuardianSkill, GuardianVirtue } from '#gw2/content/professions/guardian/types.js';
import type { SimulationEvent } from '#gw2/platform/engine/types.js';
import { applyWillbenderVirtueActivationTraits } from '#gw2/content/professions/guardian/specializations/willbender/mechanics/virtue-rules.js';
