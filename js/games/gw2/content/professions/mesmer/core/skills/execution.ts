...
import { MESMER_CORE_WEAPON_STRENGTH } from '#gw2/content/professions/mesmer/core/mechanics/definitions.js';
import type { SimulationEvent, Skill, SkillEffect, SkillHandlerStrategy } from '#gw2/platform/engine/types.js';
import type { MesmerHandlerContext } from '#gw2/content/professions/mesmer/types.js';
