...
/** Core resources and burst packets execute on the live owner; elite behavior composes at the family boundary. */
export const warriorCoreLiveMechanics: Partial<RuntimeProfession<WarriorRuntimeState>> = {
