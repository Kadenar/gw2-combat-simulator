...
export function startLiveAshes(runtime: Runtime, cast: RuntimeCast): void {
...
export function reactToFirebrandLiveDamage(
  runtime: Runtime,
  event: Gw2ResolverEvent,
...
export function reactToFirebrandLiveControl(runtime: Runtime, event: Gw2ResolverEvent): void {
...
export function reactToFirebrandLiveBuff(runtime: Runtime, event: Gw2ResolverEvent): void {
  const state = firebrandState.from(runtime);
