...
export function guardianComboFields(
  runtime: Runtime,
  cast: RuntimeCast,
...
export function guardianTraitEffects(
  runtime: Runtime,
  cast: RuntimeCast,
...
export function reactToGuardianDamage(runtime: Runtime, event: Gw2ResolverEvent, damage: number): void {
...
export function reactToGuardianBuff(runtime: Runtime, event: Gw2ResolverEvent): void {
  if (
