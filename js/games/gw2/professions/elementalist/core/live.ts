...
/** Core casts, accepted hits, and owned expiry tasks share the live runtime. */
export const elementalistCoreLive: Partial<RuntimeProfession<ElementalistRuntimeState>> = {
