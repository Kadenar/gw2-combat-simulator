...
import { elementalistAttunements, elementalistTimedBuffStacks } from '#gw2/professions/elementalist/core/modifiers.js';
...
export const weaverModifiers = { modifyAttributes: modifyWeaverAttributes, modifierRules: weaverModifierRules };
