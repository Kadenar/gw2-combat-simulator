...
export const thiefTooltips: ProfessionTooltips = {
  ...
  handlers: {
    ...
    'thief.siphon': skillTooltip(
      ...
      (balanceContext) => [
        ...
        profileFact(balanceContext, SPECTER.amplifiedSiphoning, 'resourceGain', 'Shadow Force with Amplified Siphoning')
      ]
    ),
  ...
  traits: {
    ...
    [TRAIT.IMPROVISATION]: traitTooltip(
      'Use the same stolen skill more than once. Skritt Swipe grants an additional artifact use and reduces the active cooldowns of selected utility skills.',
      (balanceContext, id) => [
    ...
    [TRAIT.LARCENOUS_TORMENT]: traitTooltip(
      'Each stack of torment you apply generates shadow force and siphons life. Life siphons bypass armor and cannot critically strike.',
    ...
    [TRAIT.AMPLIFIED_SIPHONING]: traitTooltip(
      ...
      (balanceContext, id) => [profileFact(balanceContext, id, 'resourceGain', 'Shadow force from Siphon')]
    ),
