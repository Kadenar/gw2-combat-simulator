...
export const thiefLiveInitiative: ResourcePolicy<ThiefRuntime> = {
  kind: 'continuous',
...
export function thiefLiveEnduranceRate(runtime: ThiefRuntime, vigor: boolean): number {
...
export const thiefLiveEndurance: EndurancePolicy<ThiefRuntime> = {
  state: (runtime) => runtime.profession.core,
  maximum: () => 100,
  regenerationRate: (runtime, vigor) => thiefLiveEnduranceRate(runtime, vigor)
};
