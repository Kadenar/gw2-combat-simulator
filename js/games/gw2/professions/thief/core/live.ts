...
import {
  ...
  expireThiefFlip,
  thiefCastCommitted
} from '#gw2/professions/thief/core/live-events.js';
import {
  ...
  thiefLiveEndurance,
  thiefLiveInitiative
} from '#gw2/professions/thief/core/live-resources.js';
import {
  ...
  thiefStealthed
} from '#gw2/professions/thief/core/live-stealth.js';
import {
  completeThiefSteal,
...
} from '#gw2/professions/thief/core/live-steal.js';
import {
...
} from '#gw2/professions/thief/core/live-weapons.js';
import {
...
/** Live Core: initiative, endurance, stealth, steals, weapon follow-ups, utilities, and resolved trait reactions. */
export const thiefCoreLiveMechanics: Partial<RuntimeProfession<ThiefRuntimeState>> = {
  resources: { initiative: thiefLiveInitiative },
  endurance: thiefLiveEndurance,
  initialize(runtime) {
