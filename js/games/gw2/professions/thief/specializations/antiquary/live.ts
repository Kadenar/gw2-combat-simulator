...
import { emitThiefStealTraits } from '#gw2/professions/thief/core/live-steal.js';
...
/** Live Antiquary: artifact pilfering and use, Double Edge outcomes, Skritt summons, and artifact-driven traits. */
export const antiquaryLiveMechanics: Partial<RuntimeProfession<ThiefRuntimeState>> = {
