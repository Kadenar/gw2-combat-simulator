...
import { grantThiefStealth } from '#gw2/professions/thief/core/live-stealth.js';
import {
  completeThiefSteal,
...
/** Live Deadeye: the mark and malice, malicious attacks, stolen skills, Mercy, Shadow Flare, and cantrip traits. */
export const deadeyeLiveMechanics: Partial<RuntimeProfession<ThiefRuntimeState>> = {
  initialize(runtime) {
    const state = deadeyeState.from(runtime);
    const resources = requireBalanceProfileFromContext(runtime, PROFILE.resources);
