...
import { grantThiefEndurance, thiefLiveEndurance } from '#gw2/professions/thief/core/live-resources.js';
...
/** Live Daredevil: the larger endurance pool, selected dodges, trait refunds, and Palm Strike. */
export const daredevilLiveMechanics: Partial<RuntimeProfession<ThiefRuntimeState>> = {
