...
import { completeThiefSteal, emitThiefStealTraits } from '#gw2/professions/thief/core/live-steal.js';
...
/** Live Specter: Shadow Force and its shroud, Siphon, shroud skill traits, Dark Sentry, and Larcenous Torment. */
export const specterLiveMechanics: Partial<RuntimeProfession<ThiefRuntimeState>> = {
