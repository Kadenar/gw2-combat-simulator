...
import { emitMesmerEffects, emitMesmerPacket } from '#gw2/professions/mesmer/core/live-events.js';
...
export const mesmerCoreLive: Partial<RuntimeProfession<MesmerRuntimeState>> = {
  initialize(runtime) {
