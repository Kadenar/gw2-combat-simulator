...
import { activeRevenantUpkeep, removeRevenantUpkeep } from '#gw2/professions/revenant/core/live-upkeep.js';
...
export const heraldLiveMechanics: Partial<RuntimeProfession<RevenantRuntimeState>> = {
  ...
  onCastComplete(runtime, cast) {
    ...
    if (runtime.profession.core.activeLegendId !== LEGEND.DRAGON || !revenantLiveCombatActive(runtime)) return;
