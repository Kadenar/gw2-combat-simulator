...
export const TUTORIAL_GIF_URL = new URL('@images/tutorials/gw2-combat-simulator-usage.gif', import.meta.url).href;

export const ROTATION_TUTORIAL_GIF_URL = new URL(
  '@images/tutorials/gw2-combat-simulator-rotation-builder.gif',
  import.meta.url
).href;
