...
import {
  simulatorViewFromHash,
  simulatorViewHref,
} from "../../js/app/profession/navigation.js";
...
test("simulator view links stay on the active profession page", () => {
  assert.equal(
    simulatorViewHref("/simulator/elementalist.html", "professions"),
    "elementalist.html#professions",
  );
  assert.equal(
    simulatorViewHref("/simulator/elementalist.html", "workspace"),
    "elementalist.html#workspace",
  );
  assert.equal(
    simulatorViewHref("/simulator/elementalist.html", "analysis"),
    "elementalist.html#analysis",
  );
