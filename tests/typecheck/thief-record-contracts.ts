...
import type { materializeThiefAxe } from '#gw2/professions/thief/core/mechanics/weapon-state.js';
...
export type ThiefRecordAssertions = [
  ...
  Assert<string extends keyof Parameters<typeof materializeThiefAxe>[1]['payload'] ? false : true>
];
