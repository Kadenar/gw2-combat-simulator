...
import type { rangerStealthReaction } from '#gw2/professions/ranger/core/mechanics/weapon-state.js';
type Assert<T extends true> = T;
type Payload = NonNullable<
  Parameters<(typeof rangerStealthReaction.taskHandlers)['ranger.stealth-event']>[1]['payload']
>;
