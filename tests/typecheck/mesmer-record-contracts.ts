...
import type { mesmerCriticalTraitReaction } from '#gw2/professions/mesmer/core/execution/scheduler-hooks.js';
type ProcPayload = NonNullable<Parameters<(typeof mesmerCriticalTraitReaction.taskHandlers)[string]>[1]['payload']>;
