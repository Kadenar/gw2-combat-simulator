...
import { createMesmerEventMaterializer } from '../../../js/games/gw2/content/professions/mesmer/core/mechanics/event-materializer.js';
...
test('Mesmer event materialization preserves computed identity defaults', () => {
  ...
  materializer.addCondition('Condition Skill', 2, { name: 'Bleeding', duration: 3 }, 'Clone', '', {
    source: undefined,
    sourceId: undefined
  });
...
test('Mesmer event materialization preserves explicit identity', () => {
  ...
  materializer.addCondition('Condition Skill', 2, { name: 'Bleeding', duration: 3 }, 'Player', '', {
    source: 'Phantasm',
