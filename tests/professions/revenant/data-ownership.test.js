...
import { REVENANT_LEGEND_CALL_SKILL_MECHANICS } from '#gw2/content/professions/revenant/core/skills/legend-call-skills.js';
import { REVENANT_ASSASSIN_SKILL_MECHANICS } from '#gw2/content/professions/revenant/core/skills/legends/assassin.js';
import { REVENANT_CENTAUR_SKILL_MECHANICS } from '#gw2/content/professions/revenant/core/skills/legends/centaur.js';
import { REVENANT_DEMON_SKILL_MECHANICS } from '#gw2/content/professions/revenant/core/skills/legends/demon.js';
import { REVENANT_DWARF_SKILL_MECHANICS } from '#gw2/content/professions/revenant/core/skills/legends/dwarf.js';
import { REVENANT_SUPPLEMENTAL_SKILL_MECHANICS } from '#gw2/content/professions/revenant/core/skills/supplemental-skills.js';
import { REVENANT_TRAIT_SKILL_MECHANICS } from '#gw2/content/professions/revenant/core/skills/trait-skills.js';
import { REVENANT_UNDERWATER_SKILL_MECHANICS } from '#gw2/content/professions/revenant/core/skills/underwater-skills.js';
import { CONDUIT_BASE_SKILL_MECHANICS } from '#gw2/content/professions/revenant/specializations/conduit/skills/index.js';
import { CONDUIT_COSMIC_WISDOM_SKILL_MECHANICS } from '#gw2/content/professions/revenant/specializations/conduit/skills/cosmic-wisdom-skills.js';
import { CONDUIT_ENTITY_SKILL_MECHANICS } from '#gw2/content/professions/revenant/specializations/conduit/skills/entity-skills.js';
import { CONDUIT_RELEASE_POTENTIAL_SKILL_MECHANICS } from '#gw2/content/professions/revenant/specializations/conduit/skills/release-potential-skills.js';
import { HERALD_BASE_SKILL_MECHANICS } from '#gw2/content/professions/revenant/specializations/herald/skills/index.js';
import { HERALD_BASE_SKILL_MECHANICS as HERALD_FACET_SKILL_MECHANICS } from '#gw2/content/professions/revenant/specializations/herald/skills/facet-skills.js';
import { RENEGADE_BASE_SKILL_MECHANICS } from '#gw2/content/professions/revenant/specializations/renegade/skills/index.js';
