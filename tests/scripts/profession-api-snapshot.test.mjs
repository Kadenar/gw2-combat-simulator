...
test('API snapshot fetches are English, fixture-backed, and profession-generic', async () => {
  ...
  try {
    ...
    const omittedSkillsByProfession = Object.freeze({
      ...
      thief: [
        1110, 1115, 1118, 1123, 1125, 1129, 1131, 1139, 1141, 1148, 1162, 1167, 13002, 13020, 13035, 13038, 13056,
        13060, 13065, 13096, 13099, 13117, 16435, 31438, 45094, 76550, 76601, 76784, 76800, 76808, 76879, 76900, 77288,
        77361
      ],
      warrior: [
