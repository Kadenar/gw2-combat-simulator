...
const RENDER_ICON =
  "https://render.guildwars2.com/file/617705CDC4E6D5CA0EB9F492B94B4D060F354980/1012459.png";
...
test("GW2 render icons map to the backup host by file id", () => {
  ...
  assert.equal(
    gw2BackupIconUrl("https://wiki.guildwars2.com/images/example.png"),
    "",
  );
...
test("non-render images do not enter the fallback chain", () => {
  assert.equal(
    nextGw2IconFallback("https://wiki.guildwars2.com/images/example.png"),
    null,
  );
});
