...
test("Engineer and Thief contracts present state and suppress known packet events", () => {
  const engineerRows = simulationEventLogRows({
    ...
    resolvedEvents: [],
    endState: { profession: {} },
  }, { specialization: "Holosmith" }, engineerProfession);
...
test("Guardian and Necromancer classify every known custom event", () => {
  ...
  try {
    const guardianCoreRows = simulationEventLogRows({
      ...
      resolvedEvents: [],
      endState: { profession: {} },
    }, { specialization: "Core" }, guardianProfession);
    const guardianFirebrandRows = simulationEventLogRows({
      ...
      resolvedEvents: [],
      endState: { profession: {} },
    }, { specialization: "Firebrand" }, guardianProfession);
    const guardianLuminaryRows = simulationEventLogRows({
      ...
      resolvedEvents: [],
      endState: { profession: {} },
    }, { specialization: "Luminary" }, guardianProfession);
    const guardianRows = [
      ...guardianCoreRows,
      ...guardianFirebrandRows,
      ...guardianLuminaryRows,
    ];
    assert.deepEqual(
    ...
    const necromancerCoreRows = simulationEventLogRows({
      ...
      resolvedEvents: [],
      endState: { profession: {} },
    }, { specialization: "Core" }, necromancerProfession);
    const ritualistRows = simulationEventLogRows({
      ...
      resolvedEvents: [],
      endState: { profession: {} },
    }, { specialization: "Ritualist" }, necromancerProfession);
