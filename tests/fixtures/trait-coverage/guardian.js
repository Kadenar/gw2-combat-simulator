...
const REASONS = Object.freeze({
  ...
  movement: 'Movement, mobility, and downed-state effects are not represented by the stationary PvE target model.',
  missingMechanics:
...
export const GUARDIAN_TRAIT_COVERAGE = validateTraitCoverageManifest(guardianCatalog, manifest, {
