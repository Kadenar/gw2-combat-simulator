/** Merges test overrides without discarding nested simulation defaults. */
export function prepareSimulationConfig(defaults, userConfig = {}, { duration = userConfig.duration } = {}) {
