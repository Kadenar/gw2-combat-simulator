...
const output = [
  ...
  '',
  declaration('REVENANT_SPECIALIZATION_IDS', specializations),
  '',
...
const target = fileURLToPath(new URL('../../js/games/gw2/content/professions/revenant/data/ids.ts', import.meta.url));
