...
// Generates stable Ranger IDs from the freshly fetched snapshot so the update
...
export async function generateRangerIds({ skills: apiSkills, specializations: apiSpecializations }) {
  ...
  const specializations = apiSpecializations.map((specialization) => ({
