...
export function serializeActivePatchPreview(preview) {
  return `import type { PatchPreview } from "./authoring/patches.js";
...
export function createPatchPreviewAuthoringApi({ root, buildRoot, writeFile = writeFileToDisk }) {
  ...
  // Loads the compiled simulator modules so authoring validates against the same runtime that will consume the preview.
